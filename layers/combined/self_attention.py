...
class MultiHeadAttention:
    ...
    def forward(self, query, key, value, mask, training = True):
        ...
        #print(f"Size of query: {query.nbytes / (1024 * 1024):.2f} MB")
        #print(f"Size of key: {key.nbytes / (1024 * 1024):.2f} MB")
        #print(f"Size of value: {value.nbytes / (1024 * 1024):.2f} MB")

        O = self.O_linear.forward(concat_output)
        #print(f"Size of O: {O.nbytes / (1024 * 1024):.2f} MB")
